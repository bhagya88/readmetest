...
| Arrays Loops RPS Breakpoints                                                                | 3.2      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Objects & Functions                                                                         | 3.3      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to jQuery                                                                             | 4.1      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| JavaScript Scope + jQuery Continued                                                         | 4.2      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Using Arrays & Objects With jQuery                                                          | 4.3      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Javascript Review Day                                                                       | 5.1      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Javascript / jQuery Timers                                                                  | 5.2      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Technical Interview Day #1                                                                  | 5.3      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to APIs and AJAX                                                                      | 6.1      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Advanced AJAX                                                                               | 6.2      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| New York Times Real World App Development                                                   | 6.3      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to Client-Side Storage                                                                | 7.1      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Intro to Firebase                                                                           | 7.2      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
| Firebase Application Building + Groups For Projects Announced                               | 7.3      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
...
| Interview Questions and Project Work-Pt.1                                                   | 9.1      | Invalid date<br>Invalid date   | Invalid date<br>Invalid date   | [Josh](null)<br>[Gerald](null) |
